...
~~~
composer create-project drupal/recommended-project:^10 my_site_name_dir
~~~
...
~~~
composer require drupal/views_field_view:^1.0@beta drupal/csv_serialization:^4.0 cweagans/composer-patches drupal/menu_trail_by_path:^2.0 drupal/better_exposed_filters:^6.0 drupal/better_social_sharing_buttons:^4.0 drupal/color_field:^3.0 drupal/content_synchronizer:^4.0@RC drupal/devel:^5.1 drupal/fontawesome:^2.25 drupal/jquery_ui_touch_punch:^1.1 drupal/node_read_time:^1.11 drupal/paragraphs:^1.15 drupal/pathauto:^1.11 drupal/quick_node_clone:^1.16 drupal/restui:^1.21 drupal/search_api:^1.29 drupal/site_settings:^1.20 drupal/twig_tweak:^3.2  drupal/views_show_more:^2.0 drush/drush:^12 drupal/menu_export:^1.3 drupal/chosen:^3.0 drupal/force_password_change:^2.0 drupal/smtp:^1.2 drupal/field_group:~3.4 drupal/time_field:^2.1 drupal/metatag:^1.23 drupal/textarea_widget_for_text:^1.2 drupal/conditional_fields:^4.0@alpha drupal/node_revision_delete:^2.0@alpha drupal/file_delete:^2.0 drupal/admin_toolbar:^3.4 drupal/viewsreference:^2.0@beta drupal/media_library_edit:^3.0 drupal/image_widget_crop:^2.4 drupal/extlink:^1.7 drupal/views_field_formatter:^4.0 drupal/formdazzle:^3.0 drupal/user_redirect:^2.0 drupal/menu_item_extras:^3.0 drupal/geofield:^1.53 drupal/leaflet:^10.0 drupal/svg_image_field:^2.2 drupal/views_data_export:^1.3 drupal/media_revisions_ui:^2.1 drupal/file_rename:^1.0 drupal/paragraphs_edit:^2.0 drupal/entity_usage:^2.0@beta drupal/ckeditor:^1.0 drupal/classy:^1.0 drupal/color:^1.0 drupal/color_field:^3.0 drupal/rdf:^2.0 drupal/stable:^2.0 drupal/term_revision:^2.1
